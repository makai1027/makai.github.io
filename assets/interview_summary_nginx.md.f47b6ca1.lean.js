import{_ as s,v as n,b as a,R as l}from"./chunks/framework.3d3e5663.js";const A=JSON.parse('{"title":"Nginx本地如何代理远程接口，遇到过哪些问题？","description":"Nginx本地代理常见的操作场景以及遇到问题的解决方案","frontmatter":{"title":"Nginx本地如何代理远程接口，遇到过哪些问题？","description":"Nginx本地代理常见的操作场景以及遇到问题的解决方案","head":[["meta",{"name":"keywords","content":"运维,nginx,代理,远程接口,问题"}]],"date":"2024-03-27T11:20:00.000Z","author":"马凯","tags":["前端","知识点"],"categories":["前端"],"sidebar":{"title":"Nginx本地如何代理远程接口，遇到过哪些问题？"},"isTimeLine":true},"headers":[],"relativePath":"interview/summary/nginx.md","filePath":"interview/summary/nginx.md","lastUpdated":1714988234000}'),p={name:"interview/summary/nginx.md"},o=l(`<h1 id="nginx本地如何代理远程接口-遇到过哪些问题" tabindex="-1">Nginx本地如何代理远程接口，遇到过哪些问题？ <a class="header-anchor" href="#nginx本地如何代理远程接口-遇到过哪些问题" aria-label="Permalink to &quot;Nginx本地如何代理远程接口，遇到过哪些问题？&quot;">​</a></h1><h2 id="nginx的本地安装过程" tabindex="-1">Nginx的本地安装过程 <a class="header-anchor" href="#nginx的本地安装过程" aria-label="Permalink to &quot;Nginx的本地安装过程&quot;">​</a></h2><blockquote><p>本文操作环境，macos、homebrew安装</p></blockquote><ol><li>更新homebrew</li></ol><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">brew</span><span style="color:#BABED8;"> </span><span style="color:#C3E88D;">update</span></span></code></pre></div><ol start="2"><li>查看本地安装状态</li></ol><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">brew</span><span style="color:#BABED8;"> </span><span style="color:#C3E88D;">search</span><span style="color:#BABED8;"> </span><span style="color:#C3E88D;">nginx</span></span>
